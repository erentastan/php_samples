...
<head>
    <meta charset="UTF-8">
    <title> TOPLANTIYA HOŞGELDİNİZ </title>
</head>
<body>
    <?php
    // Açıklama
    ...
    */
    ...
    echo "<br>";
    echo "Bul ve Değiştir: " . str_replace("Eren", "Salih", $isim);
    echo "<br>";
    echo "Adı Kırp: " . strstr ($isim, "TAŞTAN"); // TAŞTAN öncesini sil
    echo "<br>";
    echo "Tekrarla: " . str_repeat($ad,5);
    echo "<br>";
    echo "5.den sonra 3 tane al: " .substr($isim, 5,3);
    echo "<br>";
    ...
    $bilgi = array("Eren", "Taştan", "1962", array("Salih", "Emre"));
    ...
    echo "SABITLER";  echo "<br>";echo "===========";echo "<br>";
    define ("PI",3.14);
